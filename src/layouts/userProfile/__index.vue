<template>
    <div style="overflow-x: hidden !important;" data-proslinks-homepage>
        ...
        <!--Test-->
        <div class="row mb-3">
            <div class="col-xl-8 mb-xl-0 mx-auto pl-0 pr-0">
                <div class="panel profile-cover mb-0">
                    ...
                    <div class="profile-cover__info">
                        <ul class="nav">
                            ...
                            <!--<li><strong>26</strong>Friends</li>-->
                            <!--<li><strong>33</strong>Photos</li>-->
                            <!--<li><strong>136</strong>Comments</li>-->
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100 p ">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="text-center">
                            <h3>
                                {{ user.firstName }}
                                <span class="font-weight-light">, {{ getAge() }} </span>
                            </h3>
                            <div class="h5 font-weight-300">
                                <i class="fa fa-map-marker mr-2"></i>{{ getCityName() }},
                                {{ getCountryName() }}
                            </div>
                            <div class="h5 mt-4">
                            ...
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ getEducation() }}
                            </div>
                            <div>
                                Salary: 590 $
                            </div>
        ...
        <send-message-modal
                :receiverId="userId"
                :senderId="$store.getters.user.id"
        ></send-message-modal>
    </div>
</template>
<script>
    import {getServerAddress} from "@/utils";
    import HeaderNavBar from "../home/components/header/header-nav-bar";
    ...
    export default {
        ...
        methods: {
            ...
            getCityName() {
                let city = this.profile.city ? this.profile.city : {};
                return city.name ? city.name : "Unknown City";
            },
            getCountryName() {
